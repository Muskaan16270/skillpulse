...
export type PageKey =
  ...
  | 'providers' | 'district' | 'passport' | 'privacy' | 'followups' | 'identity';
...
export function Sidebar({ currentPage, onNavigate, onTraineeLogin }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Desktop sidebar */}
      <aside className="hidden h-screen w-64 shrink-0 border-r border-gray-200 dark:border-gray-800 lg:block">
        {sidebar}
      </aside>
